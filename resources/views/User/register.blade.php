...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <h2 class="text-center text-white mb-0 mt-5">BAWASLU</h2>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pekat.register') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="number" name="nik" placeholder="NIK (16 angka)" pattern="\d{16}" title="Nik harus terdiri dari 16 angka" class="form-control" required>
                        </div>
                        <div class="form-group">
