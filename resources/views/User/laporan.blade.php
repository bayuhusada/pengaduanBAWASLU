        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">BAWASLU</h4>
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white"
                                style="text-decoration: none">{{ Auth::guard('masyarakat')->user()->nama }}</a>
                        </li>
                        <li class="nav-item">
...
<div class="container">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #3d0c11" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            <a class="d-inline tab " href="{{ route('pekat.laporan') }}">
                Semua Pengaduan
            </a>
            <hr>
        ...
        <div class="col-lg-8">
            ...
            <div class="laporan-bottom">
                ...
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#gambarModal">
                Lihat Bukti
                </button>
                ...
                <div class="modal-header">
                  ...
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="modal-body">
                        <img src="{{ Storage::url($v->images) }}" alt="{{ 'Gambar '.$v->judul_laporan }}" style="width: 300px; ">
                        @if ($v->tanggapan !=null )
                        <p class="mt-3 mb-1">{{ 'Tanggapan dari '. $v->nama_petugas }}</p>
                        <p class="light">{{ $v->tanggapan }}</p>
                        @endif
                    </div>
